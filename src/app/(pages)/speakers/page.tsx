...
export default function Speakers() {
  return (
    <main className="flex justify-center flex-col items-center">
      ...
      <section className="pl-6 pr-6 mt-16 flex flex-col justify-center items-center maingrid xl:max-w-[1110px] xl:m-auto xl:mt-[140px]">
        <div className="mt-8 pirveli">
          ...
          <Image
            ...
            alt="headphone"
            src={data[5].categoryImage.tablet}
            width={689}
            height={352}
          />
          <Image
            ...
            alt="headphone"
            src={data[5].categoryImage.desktop}
            width={540}
            height={560}
          />
        </div>
        ...
        <div className="mt-8 meore">
          <div className=" flex justify-center flex-col items-center">
            <h1 className="text-[14px] leading-[19px] tracking-[10px] text-center font-normal pb-4 opacity-50 text-[#D87D4A] md:font-bold xl:self-start">
              NEW PRODUCT
            </h1>
            <h1 className="text-[28px] leading-[38.25px] font-bold tracking-[1px] text-center pb-6 md:text-[40px] md:leading-[44px] xl:self-start">
              {data[5].name}
            </h1>
        ...
        <div className="mt-[120px] mesame xl:mt-0">
          <Image
            className="rounded-xl md:hidden"
            alt="headphone"
            src={data[4].categoryImage.mobile}
            width={327}
            height={353}
          />
          <Image
            className="hidden md:flex rounded-xl xl:hidden"
            alt="headphone"
            src={data[4].categoryImage.tablet}
            width={689}
            height={352}
          />
          <Image
            className="hidden xl:flex rounded-xl"
            alt="headphone"
            src={data[4].categoryImage.desktop}
            width={549}
            height={560}
          />
        </div>
        ...
        <div className="mt-8 meotxe">
          <div className=" flex justify-center flex-col items-center">
            ...
            <div className="bg-[#D87D4A]  tracking-[2px] w-[160px] flex items-center justify-center pt-[15px] pb-[15px] cursor-pointer mb-[100px] xl:self-start">
              <Link
                href={"/speaker2"}
                className="text-[13px] leading-[17.76px] font-bold tracking-[1px] text-white"
              >
