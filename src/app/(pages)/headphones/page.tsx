  ...
  return (
    <main className="flex justify-center flex-col items-center ">
      ...
      <section className="pl-6 pr-6 mt-16 flex flex-col justify-center items-center maingrid xl:max-w-[1110px]">
        <div>
          <Image className="rounded-xl md:hidden" alt="headphone" src={data[3].categoryImage.mobile} width={327} height={353} />
        </div>

        <div>
          <Image className="hidden md:flex rounded-xl xl:hidden" alt="headphone" src={data[3].categoryImage.tablet} width={689} height={353} />
        </div>
        <div className="pirveli">
          <Image className="hidden xl:flex rounded-xl" alt="headphone" src={data[3].categoryImage.desktop} width={540} height={560} />
        </div>
        ...
        <div className="mt-[120px]">
          <Image className="rounded-xl md:hidden" alt="headphone" src={data[2].categoryImage.mobile} width={327} height={353} />
        </div>

        <div>
          <Image className="hidden md:flex rounded-xl xl:hidden" alt="headphone" src={data[2].categoryImage.tablet} width={689} height={353} />
        </div>
        <div className="mesame">
          <Image className="hidden xl:flex rounded-xl" alt="headphone" src={data[2].categoryImage.desktop} width={540} height={560} />
        </div>
        ...
        <Image className="rounded-xl md:hidden" alt="headphone" src={data[1].categoryImage.mobile} width={327} height={353} />
        </div>

        <div>
        <Image className="hidden md:flex rounded-xl xl:hidden" alt="headphone" src={data[1].categoryImage.tablet} width={689} height={353} />
        </div>

        <div className="mexute">
        <Image className="hidden xl:flex rounded-xl" alt="headphone" src={data[1].categoryImage.desktop} width={540} height={560} />
        </div>
      ...
      <section className="flex flex-col gap-20 mt-24 text-center md:flex-row md:gap-3 md:w-[689px] xl:-mt-[300px] xl:w-[1050px] xl:m-auto">
          <div className="relative w-[327px] h-[165px] bg-[#F1F1F1] flex  flex-col justify-between pb-[22px] rounded-xl md:w-[223px] md:h-[165px] xl:w-[350px] xl:h-[204px]">
            ...
            <Image className="xl:hidden" alt="photo" src={"/HeadPhoneHeader.svg"} width={79} height={104}/>
            <Image className="hidden xl:flex relative bottom-7" alt="photo" src={"/HeadPhoneHeader.svg"} width={121} height={104}/>
            </div>
          ...
          <div className="relative w-[327px] h-[165px] bg-[#F1F1F1] flex  flex-col justify-between pb-[22px] rounded-xl md:w-[223px] md:h-[165px]  xl:w-[350px] xl:h-[204px]">
            <div className="relative flex justify-center bottom-14">
            <Image className="xl:hidden" alt="image" src={"/SpeakerHeader.svg"} width={79} height={104} />
            <Image className="hidden xl:flex relative bottom-7" alt="image" src={"/SpeakerHeader.svg"} width={122} height={104} />
            </div>
          ...
          <div className="relative w-[327px] h-[165px] bg-[#F1F1F1] flex  flex-col justify-between pb-[22px] rounded-xl md:w-[223px] md:h-[165px]  xl:w-[350px] xl:h-[204px]">
            ...
            <Image className="xl:hidden" alt="image" src={"/earPhoneHeader.svg"} width={79} height={104} />
            <Image className=" hidden xl:flex relative bottom-7" alt="image" src={"/earPhoneHeader.svg"} width={125} height={104} />
            </div>
        ...
        <section className="flex justify-center items-center flex-col mt-[120px] xl:flex-row xl:max-w-[1050px] ">
          <Image className="rounded-xl md:hidden" alt="men" src={data[3].gallery.first.mobile} width={327} height={200} />
          <Image className="hidden md:flex rounded-xl xl:hidden" alt="men" src={"/tabletmen.svg"} width={689} height={200} />
          <Image className="hidden xl:flex rounded-xl order-2" alt="men" src={"/desktopmen.svg"} width={689} height={200} />
          <div className="text-center mt-10">
            <h1 className="text-[34px] leading-[38.25px] font-bold tracking-[1px] pb-8 md:text-[40px] md:leading-[44px] md:tracking-[1.43px] xl:text-left xl:w-[440px] uppercase">Bringing you the <span className="text-[#D87D4A]">best</span> audio gear</h1>
